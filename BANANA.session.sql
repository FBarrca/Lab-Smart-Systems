...
CREATE UNIQUE INDEX XPKMEASUREMENT ON MEASUREMENT_SECTOR (ID_SENSOR ASC, ID_MEASUREMENT_TYPE ASC);
ALTER TABLE MEASUREMENT_SECTOR
ADD CONSTRAINT XPKMEASUREMENT PRIMARY KEY (ID_SENSOR, ID_MEASUREMENT_TYPE);
...
CREATE UNIQUE INDEX XPKVALUE ON VALUE_SECTOR_SENSOR (ID_SENSOR ASC, TIMESTAMP ASC, ID_MEASUREMENT_TYPE ASC);
...
CREATE UNIQUE INDEX XPKMEASUREMENT ON MEASUREMENT_PIPE (ID_SENSOR ASC, ID_MEASUREMENT_TYPE ASC);
...
CREATE UNIQUE INDEX XPKVALUE ON VALUE_PIPE_SENSOR (ID_SENSOR ASC, TIMESTAMP ASC, ID_MEASUREMENT_TYPE ASC);
...
ALTER TABLE MEASUREMENT_SECTOR
ADD (
        CONSTRAINT R_28 FOREIGN KEY (ID_SENSOR, ID_MEASUREMENT_TYPE) REFERENCES SENSOR_SECTOR (ID_SENSOR, ID_MEASUREMENT_TYPE)
    );
ALTER TABLE MEASUREMENT_PIPE
ADD (
        CONSTRAINT R_29 FOREIGN KEY (ID_SENSOR, ID_MEASUREMENT_TYPE) REFERENCES SENSOR_PIPE (ID_SENSOR, ID_MEASUREMENT_TYPE)
    );
...
ALTER TABLE VALUE_SECTOR_SENSOR
ADD (
        CONSTRAINT R_132 FOREIGN KEY (ID_SENSOR, ID_MEASUREMENT_TYPE) REFERENCES MEASUREMENT_SECTOR (ID_SENSOR, ID_MEASUREMENT_TYPE)
    );
ALTER TABLE VALUE_PIPE_SENSOR
ADD (
        CONSTRAINT R_133 FOREIGN KEY (ID_SENSOR, ID_MEASUREMENT_TYPE) REFERENCES MEASUREMENT_PIPE (ID_SENSOR, ID_MEASUREMENT_TYPE)
    );
